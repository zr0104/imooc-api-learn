...
#imooc_001 获取广告位 yes None None api3/getbanneradvertver2 post {"username":"111111"} yes yes mec None 通过 None
...
if __name__ == '__main__':
    file_path = base_path + '/Report/test_run_report.html'
    with open(file_path,'wb') as f:
        runner = HTMLTestRunner.HTMLTestRunner(stream=f,title="ddt测试报告",description="Senzr")
        runner.run(add_case())
    f.close()
